...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2010, 10, 10), new DateTime(2010, 10, 20), 200);
            var remainingFlight = new Flight(new DateTime(2010, 10, 11), new DateTime(2010, 10, 21), 201);
